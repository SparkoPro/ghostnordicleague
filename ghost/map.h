...
private:
	...
	string m_MapDownloadLink;
	bool m_MapSendDownloadLink;
...
public:
	...
	bool GetMapSendDownloadLink()			{ return m_MapSendDownloadLink; }
	string GetMapDownloadLink()				{ return m_MapDownloadLink; }
