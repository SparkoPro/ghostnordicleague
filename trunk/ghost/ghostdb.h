...
public:
	...
	virtual uint32_t DotAEventAdd( uint32_t gameid, string killer, string victim );
	...
	virtual CCallableDotAEventAdd *ThreadedDotAEventAdd( uint32_t gameid, string Killer, string Victim );
...
class CCallableDotAEventAdd : virtual public CBaseCallable
{
protected:
	uint32_t m_GameID;
	string m_Killer;
...
public:
	CCallableDotAEventAdd( uint32_t nGameID, string nKiller, string nVictim ) : CBaseCallable( ), m_GameID( nGameID), m_Killer( nKiller ), m_Victim( nVictim ), m_Result( 0 ) { }
...
public:
	...
	CDBDotAPlayerSummary( string nServer, string nName, uint32_t nTotalGames, uint32_t nTotalWins, uint32_t nTotalLosses, uint32_t nTotalKills, uint32_t nTotalDeaths, uint32_t nTotalCreepKills, uint32_t nTotalCreepDenies, uint32_t nTotalAssists, uint32_t nTotalNeutralKills, uint32_t nTotalTowerKills, uint32_t nTotalRaxKills, uint32_t nTotalCourierKills, uint32_t nRank, uint32_t nScore );
	~CDBDotAPlayerSummary( );
